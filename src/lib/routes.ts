...
export const routes: Record<RouteSlug, FacialRoute> = {
  "rejuvenecimiento-facial": {
    ...
    problem: "Su rostro no necesita más producto; necesita un plan correcto. El rostro cambia con el tiempo, la expresión, la exposición solar y otros factores.",
    ...
    solution: "Evaluamos el rostro completo para definir naturalidad, proporciones y un plan individual, paso a paso.",
    assessment: "Durante la valoración revisamos sus objetivos, antecedentes, movimientos, proporciones, piel y tratamientos previos. Definimos qué tiene sentido tratar y qué no.",
    treatments: [
      { name: "Toxina botulínica", text: "Para valorar líneas de expresión y movimiento facial según su anatomía." },
      ...
      { name: "Pómulos y equilibrio facial", text: "Valoración de balance y proporciones del rostro." },
    ...
    benefits: [
      ...
      "Conocer alternativas y sus límites.",
      "Mantener una apariencia coherente con su identidad.",
      "Contar con seguimiento posterior según indicación.",
    ],
    faq: [
      ["¿Qué incluye la valoración facial?", "Incluye una revisión de objetivos, antecedentes, tratamientos previos y una evaluación médica del rostro para orientar las alternativas."],
      ...
      ["¿Se puede mantener un resultado natural?", "La naturalidad y sus preferencias forman parte del plan, junto con las posibilidades y límites clínicos."],
    ...
    priceFrom: 150,
    priceNote,
    categorySlugs: ["toxina-botulinica", "acido-hialuronico", "bioestimulacion", "laser-piel", "protocolos"],
  ...
  acne: {
    ...
    treatments: [
      ...
      { name: "Control de grasa e inflamación", text: "Revisión de hábitos, productos y opciones médicas." },
    ...
    faq: [
      ...
      ["¿El acné sólo se trata con productos?", "Depende de la historia y el tipo de lesiones. La valoración permite definir cuidados, procedimientos y otras opciones médicas."],
      ...
      ["¿Qué debo llevar a la valoración?", "Una lista de productos, medicamentos y tratamientos previos ayuda a ordenar la valoración."],
  ...
  "cicatrices-acne": {
    ...
    solution: "Clasificamos las características visibles y diseñamos una secuencia de técnicas, sesiones y cuidados realistas.",
    ...
    treatments: [
      { name: "Láser fraccionado", text: "Tecnología que puede indicarse para textura y cicatrices seleccionadas." },
    ...
    benefits: [
      ...
      "Conocer técnicas, sesiones y recuperación.",
      "Definir expectativas más realistas para su piel.",
      "Revisar la evolución y ajustar el protocolo.",
    ],
    faq: [
      ["¿Las cicatrices pueden eliminarse por completo?", "No se promete eliminación completa. El objetivo se define según el tipo de cicatriz y las posibilidades de su piel."],
      ["¿Qué significa ice pick, boxcar o rolling?", "Son descripciones de formas y profundidades distintas. Identificarlas ayuda a orientar la técnica indicada."],
