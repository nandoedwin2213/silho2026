...
export default async function CheckoutPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  const [discount, transferInstructions] = await Promise.all([getWebDiscountFor(service), getSetting("BANK_TRANSFER_INSTRUCTIONS", "Te contactaremos para compartir los datos de transferencia y validar tu pago.")]);
