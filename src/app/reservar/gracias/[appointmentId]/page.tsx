...
export default async function BookingThanksPage({ params, searchParams }: { params: Promise<{ appointmentId: string }>; searchParams: Promise<{ pago?: string }> }) {
