...
export function ServiceCard({ service, categorySlug }: { service: Pick<Service, "name" | "slug" | "shortDescription" | "basePrice" | "priceFrom" | "showPrice" | "discountEligible" | "isSurgical" | "requiresMedicalAssessment" | "requiresManualQuote" | "image">; categorySlug: string }) {
